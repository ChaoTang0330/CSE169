...
void BallJoint::getRot(glm::vec3& rot)
{
	rot.x = rotX->getValue();
	rot.y = rotY->getValue();
	rot.z = rotZ->getValue();
...
void BallJoint::getRotMin(glm::vec3& rotMin)
{
	rotMin.x = rotX->getMin();
	rotMin.y = rotY->getMin();
	rotMin.z = rotZ->getMin();
}

void BallJoint::getRotMax(glm::vec3& rotMax)
{
	rotMax.x = rotX->getMax();
	rotMax.y = rotY->getMax(),
	rotMax.z = rotZ->getMax();
}